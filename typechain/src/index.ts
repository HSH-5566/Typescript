...
class Block {
    ...
    static validateStructure = (aBlock: Block): boolean =>
         typeof aBlock.index === "number" && typeof aBlock.previousHash === "string" &&
         typeof aBlock.hash === "string" &&
         typeof aBlock.data === "string" && typeof aBlock.timestamp === "number";
...
const genesisBlock: Block = new Block(0, "1221","","Hello",1234);
...
createNewBlock("threeBlock");
createNewBlock("fourBlock");
